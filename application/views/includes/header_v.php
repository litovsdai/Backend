        ...
        <div class="container-fluid">
            ...
            <div class="modal hide fade" id="myModal">
                ...
                <div class="modal-body">
                    <div style="border-bottom: 1px solid #0B90C4;padding: 1%;margin-bottom: 2%;border-radius: .3;">
                    ...
                    <!-- Subir imagen -->
                    <div style="border-bottom: 1px solid #0099FF;border-top: 1px solid #0099FF;padding: 1%;margin-bottom: 2%;border-radius: .3;">
                        ...
                        <div class="control-group"  style="color:black;">
                            ...
                            <div class="controls">
                                ...
                                &nbsp;&nbsp;&nbsp;
                                <input type="submit" style="margin-left: 5%px;" class="btn btn-primary" name="subirr" value="Subir imagen" />
                            </div>
                        </div> 
                        </form>
                    </div>
                    <!-- FIN subir imagen -->
                    <div style="border-top: 1px solid #7ed0e5;padding: 1% 1% 0 1%;border-radius: .3;">
