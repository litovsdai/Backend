<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-picture"></i> <?= lang('multi_edit_img_1') ?></h2>
            <div class="box-icon">
        ...
        <div class="box-content" style="text-align: center;"> 
            <button class="btn show_"><i class="icon-edit"></i> <?= lang('multi_edit_img_3') ?></button>    
            <br />
            ...
            if (isset($categ) && isset($all_category) && $all_category !== 0) {
                ...
                echo '<p style="text-align:center;color:tomato;">' . lang('multi_edit_img_4') . '</p>';
            }

            if (isset($img_sin) && $img_sin !== 0) {
                echo '<h2 style="text-decoration:underline;">' . lang('multi_edit_img_5') . '</h2>';
                echo '<ul class="thumbnails gallery">';
